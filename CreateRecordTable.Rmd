...
# create record table
record.table.all <- recordTable(inDir = "Data-21-22", # folder with the camera folders in it
...
write.csv(record.table.all, "Data-21-22_Record_Table.csv", row.names = FALSE)
